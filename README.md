...
- [Miscellaneous code snippets and helper utility functions](#miscellaneous-code-snippets-and-helper-utility-functions)
  - [Website workflow](#website-workflow)
    - [github pages rendering](#github-pages-rendering)
  - [R package development](#r-package-development)
    - [CRAN submission](#cran-submission)
    - [update packages with a packagedown site](#update-packages-with-a-packagedown-site)
  - [stats related](#stats-related)
    - [quick linear model of predictors association with outcome](#quick-linear-model-of-predictors-association-with-outcome)
    - [quick t test of predictors association with outcome](#quick-t-test-of-predictors-association-with-outcome)
    - [simple scale function](#simple-scale-function)
  - [genomics related](#genomics-related)
    - [convert entrez IDs to gene symbols visa versa](#convert-entrez-ids-to-gene-symbols-visa-versa)
  - [data wrangling](#data-wrangling)
  - [specify a conflicted function preference](#specify-a-conflicted-function-preference)
    - [create multiple grouped aggregation and summary stats simultaneously](#create-multiple-grouped-aggregation-and-summary-stats-simultaneously)
    - [select specific columns matching string](#select-specific-columns-matching-string)
    - [filter rows matching a string](#filter-rows-matching-a-string)
    - [lead and lag to calculate a fold change](#lead-and-lag-to-calculate-a-fold-change)
  - [data visualization](#data-visualization)
    - [Make the 0 point of a diverging color palette white](#make-the-0-point-of-a-diverging-color-palette-white)
    - [color adjust a single color to manually add transparency](#color-adjust-a-single-color-to-manually-add-transparency)
  - [ggplot related](#ggplot-related)
    - [ggplot change legend key shape from the main geom on the plot](#ggplot-change-legend-key-shape-from-the-main-geom-on-the-plot)
    - [gplot Change all the legend element sizes](#gplot-change-all-the-legend-element-sizes)
    - [ggplot clean theme](#ggplot-clean-theme)
    - [ggplot make the axis tics more natural and uniform](#ggplot-make-the-axis-tics-more-natural-and-uniform)
    - [ggplot rotate axis](#ggplot-rotate-axis)
  - [strings](#strings)
    - [separate something by the first space get the short name](#separate-something-by-the-first-space-get-the-short-name)
    - [remove a subset of vector elements based on regex](#remove-a-subset-of-vector-elements-based-on-regex)
    - [put quotes around each element of a vector - useful for making gene lists](#put-quotes-around-each-element-of-a-vector---useful-for-making-gene-lists)
  - [error handling and control flow with trycatch](#error-handling-and-control-flow-with-trycatch)
    - [using trycatch](#using-trycatch)
  - [Lists](#lists)
    - [combine a list into a named dataframe](#combine-a-list-into-a-named-dataframe)
    - [flatten a list of lists into the top level list base R only](#flatten-a-list-of-lists-into-the-top-level-list-base-r-only)
    - [reorder a list based on vector](#reorder-a-list-based-on-vector)
  - [Git](#git)
    - [git workflow](#git-workflow)
    - [remove accidental COMITTED file from git history](#remove-accidental-comitted-file-from-git-history)
    - [remove accidental PUSHED file from git history](#remove-accidental-pushed-file-from-git-history)
    - [to ignore entire file path in project directory recursively in the gitignore file add:](#to-ignore-entire-file-path-in-project-directory-recursively-in-the-gitignore-file-add)
    - [to ignore a single file in each sub directory with the same name (ignore all generated data and figures)](#to-ignore-a-single-file-in-each-sub-directory-with-the-same-name-ignore-all-generated-data-and-figures)
    - [generating the r markdown included in git repo as a pdf](#generating-the-r-markdown-included-in-git-repo-as-a-pdf)
  - [Linux and HPC related](#linux-and-hpc-related)
    - [Show directory structure as a tree](#show-directory-structure-as-a-tree)
  - [Reticulate](#reticulate)
    - [python virtual env](#python-virtual-env)
  - [system related](#system-related)
    - [speed up time machine backups](#speed-up-time-machine-backups)
    - [stay awake](#stay-awake)
  - [old reference](#old-reference)
    - [Non standard evaluation for programming with dplyr verbs](#non-standard-evaluation-for-programming-with-dplyr-verbs)
    - [Seurat v2 conversion to v3 or 4 +](#seurat-v2-conversion-to-v3-or-4-)
